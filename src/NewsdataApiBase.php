...
class NewsdataApiBase {
    ...
    /**
     * GET Sentiment API Base URL
     * @return string
     */
    protected function NewsApiURL():string
    {
        return self::API_HOST.self::API_BASE_PATH.self::API_VERSION.'/news';
    }
    
    /**
     * GET EmotionAPI Base URL
     * @return string
     */
    protected function ArchiveApiURL():string
    {
        return self::API_HOST.self::API_BASE_PATH.self::API_VERSION.'/archive';
    }
    
    /**
     * GET Keyword API Base URL
     * @return string
     */
    protected function SourcesApiURL():string
    {
        return self::API_HOST.self::API_BASE_PATH.self::API_VERSION.'/sources';
    }
